...
ActiveRecord::Schema.define(:version => 20130225223102) do
  ...
  add_index "friendships", ["user_id", "friendship_id"], :name => "index_friendships_on_user_id_and_friendship_id", :unique => true
