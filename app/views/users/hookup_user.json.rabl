object @user
attributes :id, :updated_at, :first_name, :last_name, :location, :birthday, :gender, :email, :photo_url, :looking_for_gender, :country, :city, :vk_domain, :vk_university_name, :vk_graduation, :vk_faculty_name
